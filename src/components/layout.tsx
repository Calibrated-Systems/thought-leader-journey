...
const Layout = (props: LayoutProps) => {
  ...
  return (
    <MetaProvider>
      <Title>Thought Leader - Journey of Influence</Title>
      <div class={styles.layoutContainer}>
        <div class={styles.mainWrapper}>
          ...
          <div class={styles.mainContainer}>
            ...
            <header class={styles.header}>
              <h1 class={styles.headerTitle}>Thought Leader - Journey of Influence</h1>
            </header>
        ...
        <footer class={styles.footer}>
          <p>&copy; {new Date().getFullYear()} Calibrated Systems. All rights reserved.</p>
        </footer>
      </div>
    </MetaProvider>
  );
